    ...
    Language.insertMany([
        {
            ...
            "pangram": "à¤‹à¤·à¤¿à¤¯à¥‹à¤‚ à¤•à¥‹ à¤¸à¤¤à¤¾à¤¨à¥‡ à¤µà¤¾à¤²à¥‡ à¤¦à¥à¤·à¥à¤Ÿ à¤°à¤¾à¤•à¥à¤·à¤¸à¥‹à¤‚ à¤•à¥‡ à¤°à¤¾à¤œà¤¾ à¤°à¤¾à¤µà¤£ à¤•à¤¾ à¤¸à¤°à¥à¤µà¤¨à¤¾à¤¶ à¤•à¤°à¤¨à¥‡ à¤µà¤¾à¤²à¥‡ à¤µà¤¿à¤·à¥à¤£à¥à¤µà¤¤à¤¾à¤° à¤­à¤—à¤µà¤¾à¤¨ à¤¶à¥à¤°à¥€à¤°à¤¾à¤®, à¤…à¤¯à¥‹à¤§à¥à¤¯à¤¾ à¤•à¥‡ à¤®à¤¹à¤¾à¤°à¤¾à¤œ à¤¦à¤¶à¤°à¤¥ à¤•à¥‹ à¤¬à¤¡à¤¼à¥‡ à¤¸à¤ªà¥à¤¤à¥
        },
        {
            "name": "swahili",
...
languages.get('/:name', (req, res) => {
    ...
    Language.findOne({ name })
        .then(foundLanguage => {
            res.status(200).json(foundLanguage);
        })
        .catch(err => {
            console.error(err);
            res.status(500).json({ error: err.message });
